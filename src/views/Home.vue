<template>
  <div class="home" id="quotes">
    ...
    <div class="filter">
      <label><input type="radio" v-model="selectedTheme" value="All" /> All </label>
      <label><input type="radio" v-model="selectedTheme" value="movies" /> Movies </label>
      <label><input type="radio" v-model="selectedTheme" value="games" /> Games </label>
    </div><br>
    <div class="form-group">
      <label for='quote'> Search By Quote Per Page </label>
      <input type="text" v-model="quoteFilter">
    </div><br>
    <div v-for= "quote in filterBy(splicedQuotes, quoteFilter, 'quote')">
      <h1>"{{ quote.quote }}"</h1>
      <div class="source">
        <h2> - {{ quote.source}}</h2>
        <h3>{{ quote.context}}</h3>
...
export default {
  ...
  data: function() {
    return {
      quotes: [
        ...
        {"quote":"Ray, next time someone asks you if you’re a god, you say YES!","context":"Ghostbusters","source":"Winston Zeddemore", "theme":"movies"},
        ...
        {"quote": "Momentum, a function of mass and velocity, is conserved between portals. In layman's terms, speedy thing goes in, speedy thing comes out.","context":"Portal","source":"GlaDOS", "theme":"games"},
        {"quote": "You talkin' to me?","context": "Taxi Driver","source": "Travis Bickle", "theme": "movies"},
        {"quote": "Are you not entertained! Are you not entertained! Is this not why you are here!","context": "Gladiator","source": "Maximus", "theme": "movies"},
        {"quote": "Here's Johnny","context": "Jack Torrance","source": "The Shining", "theme": "movies"},
        {"quote": "Mama always said life was like a box of chocolates. You never know what you're gonna get.","context": "Forest Gump","source": "Forest Gump", "theme": "movies"},
        {"quote": "E.T. phone home","context": "E.T.","source": "E.T. The Extra-Terrestrial", "theme": "movies"},
        {"quote": "Toto, I've got a feeling we're not in Kansas anymore","context": "Dorothy","source": "The Wizard of Oz", "theme": "movies"},
        {"quote":"Open the pod bay doors, please, HAL","context":"2001: A Space Odyssey","source":"Dave", "theme":"movies"},
        {"quote":"I'm not bad. I'm just drawn that way.", "source":"Jessica Rabbit", "context":"Who Framed Roger Rabbit",  "theme":"movies"},
        {"quote":"When I first saw you, I thought you were handsome. Then, of course, you spoke.", "source":"Carol", "context":"As Good As It Gets",  "theme":"movies"},
        {"quote":"Listen, here's the thing. If you can't spot the sucker in your first half hour at the table, then you ARE the sucker.", "source":"Mike", "context":"Rounders",  "theme":"movies"},
        {"quote":"The cake is a lie","context":"Portal","source":"Corpse", "theme":"games"},
        {"quote":"Welcome, everybody, to Monday Night Combat! We'd like to remind fans that we're committed to creating a safe, comfortable, enjoyable experience for only our Club-level and VIP guests. Everybody else...pay up for better seats next time!", "context":"Monday Night Combat", "source": "Mickey",  "theme":"games"},
        {"quote":"Good men mean well. We just don't always end up doing well", "context":"Dead Space 3", "source": "Isaac",  "theme":"games"},
        {"quote":"The next time you raise a hand to me will be the last time you have hands", "context":"Game of Thrones", "source":"Khaleesi", "theme":"movies"},
        {"quote":"I'm not in the meth business. I'm in the empire business", "context":"Breaking Bad", "source":"Walter", "theme":"movies"},
        {"quote":"If you don't like what's being said, change the conversation", "context":"Mad Men", "source":"Don Draper", "theme":"movies"}
      ],
      startingQuote: 0, 
      maxQuotes: 15,
      endQuote: 15,
  ...
  computed: {
    ...
    splicedQuotes: function() {
      return this.filteredQuotes.slice(this.startingQuote, this.endQuote)
    },
    ...
    filteredQuotes: function() {
      ...
      if(theme === "All") {
        ...
        return vm.quotes.filter(function(quote) {
          return quote.theme === theme;
        });
      }
    }
  },
